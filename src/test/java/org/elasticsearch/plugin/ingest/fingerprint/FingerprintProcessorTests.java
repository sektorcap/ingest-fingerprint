...
public class FingerprintProcessorTests extends ESTestCase {
    ...
    public void testThatProcessorWorksWithString() throws Exception {
        Map<String, Object> document = new HashMap<>();
        document.put("source_field", "fancy source field content");
        IngestDocument ingestDocument = RandomDocumentPicks.randomIngestDocument(random(), document);

        FingerprintProcessor processor = new FingerprintProcessor(randomAsciiOfLength(10), "source_field",
                                                                                           "target_field",
                                                                                           "testkey",
                                                                                           "HmacSHA1");
